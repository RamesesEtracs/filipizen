...
//styling
import styles from './welcomePage_2.style'
        ...
        <View style={styles.upperPageContainer}>
          ...
          <View style={styles.imageParentContainer}>
            <View style={styles.svgContainer}>
              <Svg width="200" height="150" fill="none">
                <Circle
                  cx="75" cy="75" r="70" fill="#FFECC9" stroke="#fff" stroke-width="4"
                />
              </Svg>
            </View>
